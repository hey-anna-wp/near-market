...
export default function LoginPage() {
  ...
  return (
    <PageLayout className="grid gap-6 md:grid-cols-[0.95fr_1.05fr] lg:gap-10">
      ...
      <section className="rounded-[28px] border border-[#E6E6E6] bg-white p-5 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <Mail size={18} className="absolute top-1/2 left-4 -translate-y-1/2 text-[#6B8A58]" />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Lock size={18} className="absolute top-1/2 left-4 -translate-y-1/2 text-[#6B8A58]" />
        ...
        <div className="mt-6 rounded-2xl bg-[#FAFAF8] p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-[#777777]">
            현재는 Supabase Auth 연결 전이라 실제 로그인은 되지 않습니다. 입력값 검증과 화면 흐름만
            확인할 수 있습니다.
          </p>
        </div>
