...
이 프로젝트는 지역 기반 중고거래 서비스의 기본 사용 흐름을 기준으로
페이지를 구성했습니다.
...
/products/[id]
└─ not-found.tsx     존재하지 않는 상품 접근 시 표시되는 Not Found 화면
```
...
> 채팅 기능은 현재 필수 구현 범위에서 제외했으며, 추후 Supabase
> Realtime을 활용해 확장할 예정입니다.
...
- [x] 더미데이터 기반 상품 목록 조회 UI
- [x] 상품 상세 페이지 UI
- [x] 상품 등록 페이지 UI
- [x] 상품 수정 페이지 UI
- [x] 판매중 / 예약중 / 거래완료 상태 표시
- [ ] Supabase 기반 상품 목록 조회
- [ ] Supabase 기반 상품 등록
- [ ] Supabase 기반 상품 수정
- [ ] Supabase 기반 상품 삭제
...
- [x] 카테고리별 상품 필터 UI
- [x] 거래 상태별 상품 필터 UI
- [x] 최신순 / 가격순 / 관심 많은순 정렬 UI
- [ ] 지역별 상품 필터
- [ ] Supabase 쿼리 기반 검색 / 필터 연동

### 관심 상품

- [x] 더미데이터 기반 관심 상품 목록 UI
- [x] 관심 상품 해제 UI
- [x] 관심 상품 없음 상태 처리
- [ ] Supabase 기반 관심 상품 등록
- [ ] Supabase 기반 관심 상품 해제
- [ ] Supabase 기반 관심 상품 목록 조회
